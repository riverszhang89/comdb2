...
static int os_get_host_and_canonname_by_name(const char *name,
                                             struct in_addr *addr,
                                             char **canonname)
{
    int rc;
...
static hostbyname *hostbyname_impl = os_get_host_and_canonname_by_name;
...
{
    return hostbyname_impl(name, NULL, canonname);
}

hostbyname *get_os_hostbyname(void)
{
    return os_get_host_and_canonname_by_name;
}
