...
BERK_DEF_ATTR(trickle_smooth_factor, "A larger value make cache flush more smooth but may suffer from performance dip if the workload changes rapidly.", BERK_ATTR_TYPE_INTEGER, 16)
...
BERK_DEF_ATTR(trickle_min, "A lower bound of the number of pages to be flushed so that we will make a little progress and flush out all dirty pages after an idle period.", BERK_ATTR_TYPE_INTEGER, 4)
