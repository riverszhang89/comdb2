...
comdb2_metric gbl_metrics[] = {
    ...
    {"pgmv_ndeadlocks", "Number of deadlocks", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_ndeadlocks, NULL},
    {"pgmv_nflsorts", "Number of freelist sorts", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_nflsorts, NULL},
    {"pgmv_novflreads", "Number of overflow page reads", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_novflreads, NULL},
    ...
    {"pgmv_novflswaps", "Number of overflow page swaps", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_novflswaps, NULL},
    {"pgmv_npgreads", "Number of page reads", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_npgreads, NULL},
    {"pgmv_npgskips", "Number of pages skipped", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_npgskips, NULL},
    {"pgmv_npgswapattempts", "Number of page swap attempts", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_npgswapattempts, NULL},
    {"pgmv_npgswaps", "Number of overflow page swaps", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_npgswaps, NULL},
    {"pgmv_npgtruncates", "Number of pages truncated", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_npgtruncates, NULL},
    {"pgmv_nresizes", "Number of file resizes", STATISTIC_INTEGER,
     STATISTIC_COLLECTION_TYPE_CUMULATIVE, &stats.pgmv_nresizes, NULL},
