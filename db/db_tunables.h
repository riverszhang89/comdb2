...
REGISTER_TUNABLE("disable_selectv_range_check",
                 ...
                 &gbl_selectv_rangechk, INVERSE_VALUE | NOARG | READEARLY, NULL, NULL, NULL,
                 NULL);
...
REGISTER_TUNABLE("iam_base_bri",
                 ...
                 NULL, NULL, NULL);
REGISTER_TUNABLE("iam_metrics_namespace",
                 "metrics namespace for IAM user metrics (default: comdb2-iam)",
                 TUNABLE_STRING, &gbl_iam_metrics_namespace, READEARLY | READONLY, NULL,
                 NULL, NULL, NULL);
