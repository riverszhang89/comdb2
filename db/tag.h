...
int create_key_from_ondisk(const struct dbtable *db, int ixnum, char **tail, int *taillen,
                           char *mangled_key, const char *inbuf, int inbuflen,
                           char *outbuf, struct convert_failure *reason, const char *tzname);
